function [start_time_pc, start_time, newBufferData, sample_i] = ...
    StartTPxRecording(duration, bufferAddress, bufferColumns)
...
if nargin == 0
    ...
    bufferColumns = 19; % 14 columns from ReadTPxData + 1 for pc_time + 4 for screen coordinates
elseif nargin == 1
    bufferAddress = 12e6;
    bufferColumns = 19;
elseif nargin == 2
...
TPx_sampling_freq = const.TPx_sampling_rate; % so far there is only one sampling frequency, i.e., 2000 Hz
